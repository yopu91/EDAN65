...
/**
 * @ast node
 * @declaredat /h/dc/y/zba08ath/EDAN65/A2/EDAN65/CalcRag/src/jastadd/calc.ast:12
...
public class Binding extends ASTNode<ASTNode> implements Cloneable {
  /**
   * @aspect PrettyPrint
   * @declaredat /h/dc/y/zba08ath/EDAN65/A2/EDAN65/CalcRag/src/jastadd/PrettyPrint.jrag:53
   */
  ...
  public boolean Define_inExprOf(ASTNode caller, ASTNode child, IdDecl decl) {
    if (caller == getExprNoTransform()) {
      // @declaredat /h/dc/y/zba08ath/EDAN65/A2/EDAN65/CalcRag/src/jastadd/NameAnalysis.jrag:35
