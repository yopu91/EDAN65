...
/**
 * @ast node
 * @declaredat /h/dc/y/zba08ath/EDAN65/A2/EDAN65/CalcRag/src/jastadd/calc.ast:9
...
public class IdUse extends Expr implements Cloneable {
  /**
   * @aspect PrettyPrint
   * @declaredat /h/dc/y/zba08ath/EDAN65/A2/EDAN65/CalcRag/src/jastadd/PrettyPrint.jrag:31
   */
   ...
   * @attribute inh
   * @aspect NameAnalysis
   * @declaredat /h/dc/y/zba08ath/EDAN65/A2/EDAN65/CalcRag/src/jastadd/NameAnalysis.jrag:3
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @declaredat /h/dc/y/zba08ath/EDAN65/A2/EDAN65/CalcRag/src/jastadd/NameAnalysis.jrag:33
   */
  @ASTNodeAnnotation.Attribute
   ...
   * @declaredat /h/dc/y/zba08ath/EDAN65/A2/EDAN65/CalcRag/src/jastadd/Errors.jrag:34
   */
    if (decl().isUnknown()) {
      {
   ...
   * @attribute coll
   * @aspect ErrorContributions
   * @declaredat /h/dc/y/zba08ath/EDAN65/A2/EDAN65/CalcRag/src/jastadd/Errors.jrag:42
   */
    if (isCircular()) {
      {
        Program ref = (Program) (program());
