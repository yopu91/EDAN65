...
/**
 * @ast node
 * @declaredat /h/dc/y/zba08ath/EDAN65/A2/EDAN65/CalcRag/src/jastadd/calc.ast:11
...
public class Let extends Expr implements Cloneable {
  /**
   * @aspect PrettyPrint
   * @declaredat /h/dc/y/zba08ath/EDAN65/A2/EDAN65/CalcRag/src/jastadd/PrettyPrint.jrag:39
   */
  ...
  public IdDecl Define_lookup(ASTNode caller, ASTNode child, String name) {
    if (caller == getBindingListNoTransform()) {
      // @declaredat /h/dc/y/zba08ath/EDAN65/A2/EDAN65/CalcRag/src/jastadd/NameAnalysis.jrag:21
      ...
      // @declaredat /h/dc/y/zba08ath/EDAN65/A2/EDAN65/CalcRag/src/jastadd/NameAnalysis.jrag:5
      {
