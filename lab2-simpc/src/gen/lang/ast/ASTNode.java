...
public class ASTNode<T extends ASTNode> extends beaver.Symbol implements Cloneable, Iterable<T> {
  /**
   * @aspect DumpTree
   * @declaredat /h/dc/y/zba08ath/EDAN65/A2/EDAN65/lab2-simpc/src/jastadd/DumpTree.jrag:6
   */
  private String DUMP_TREE_INDENT = "  ";
  /**
   * @aspect DumpTree
   * @declaredat /h/dc/y/zba08ath/EDAN65/A2/EDAN65/lab2-simpc/src/jastadd/DumpTree.jrag:8
   */
  ...
  /**
   * @aspect DumpTree
   * @declaredat /h/dc/y/zba08ath/EDAN65/A2/EDAN65/lab2-simpc/src/jastadd/DumpTree.jrag:14
   */
  ...
  /**
   * @aspect DumpTree
   * @declaredat /h/dc/y/zba08ath/EDAN65/A2/EDAN65/lab2-simpc/src/jastadd/DumpTree.jrag:19
   */
