...
/**
 * @ast node
 * @declaredat /h/dk/r/ada10dlu/edan65/lab2-simpc/src/jastadd/lang.ast:13
 * @production Argument : {@link ASTNode} ::= <span class="component">{@link IdUse}</span>;
