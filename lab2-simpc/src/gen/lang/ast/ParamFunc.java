...
/**
 * @ast node
 * @declaredat /h/dk/r/ada10dlu/edan65/lab2-simpc/src/jastadd/lang.ast:4
 * @production ParamFunc : {@link Function} ::= <span class="component">{@link IdUse}</span> <span class="component">{@link Param}*</span> <span class="component">{@link Stmt}*</span>;
...
public class ParamFunc extends Function implements Cloneable {
   ...
   */
  public ParamFunc(IdUse p0, List<Param> p1, List<Stmt> p2) {
    setChild(p0, 0);
    setChild(p1, 1);
    setChild(p2, 2);
  }
