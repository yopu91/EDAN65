...
/**
 * @ast node
 * @declaredat /h/dk/r/ada10dlu/edan65/simpc-6/src/jastadd/lang.ast:32
 * @production BoolType : {@link TypeId};

 */
public class BoolType extends TypeId implements Cloneable {
  /**
