...
/**
 * @ast node
 * @declaredat /h/dk/r/ada10dlu/edan65/simpc/src/jastadd/lang.ast:19
 * @production Declare : {@link Stmt} ::= <span class="component">Identifier:{@link IdDecl}</span> <span class="component">[{@link Expr}]</span>;

 */
public class Declare extends Stmt implements Cloneable {
  /**
   * @aspect NameAnalysis
   * @declaredat /h/dk/r/ada10dlu/edan65/simpc/src/jastadd/NameAnalysis.jrag:127
   */
  ...
  /**
   * @aspect PrettyPrint
   * @declaredat /h/dk/r/ada10dlu/edan65/simpc/src/jastadd/PrettyPrint.jrag:167
   */
  ...
  /**
   * @aspect Visitor
   * @declaredat /h/dk/r/ada10dlu/edan65/simpc/src/jastadd/Visitor.jrag:78
   */
   ...
   * @apilevel high-level
   */
  public void setIdentifier(IdDecl node) {
    setChild(node, 0);
  }
  /**
   ...
   * @apilevel low-level
   */
  public IdDecl getIdentifierNoTransform() {
