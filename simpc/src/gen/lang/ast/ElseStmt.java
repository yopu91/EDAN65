...
/**
 * @ast node
 * @declaredat /h/dk/r/ada10dlu/edan65/simpc/src/jastadd/lang.ast:11
 * @production ElseStmt : {@link Stmt} ::= <span class="component">{@link Stmt}*</span>;

 */
public class ElseStmt extends Stmt implements Cloneable {
  /**
   * @aspect NameAnalysis
   * @declaredat /h/dk/r/ada10dlu/edan65/simpc/src/jastadd/NameAnalysis.jrag:105
   */
  ...
  /**
   * @aspect PrettyPrint
   * @declaredat /h/dk/r/ada10dlu/edan65/simpc/src/jastadd/PrettyPrint.jrag:136
   */
  ...
  /**
   * @aspect Visitor
   * @declaredat /h/dk/r/ada10dlu/edan65/simpc/src/jastadd/Visitor.jrag:66
   */
