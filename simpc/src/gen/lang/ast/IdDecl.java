...
/**
 * @ast node
 * @declaredat /h/dk/r/ada10dlu/edan65/simpc/src/jastadd/lang.ast:25
...
public class IdDecl extends ASTNode<ASTNode> implements Cloneable {
  /**
   * @aspect NameAnalysis
   * @declaredat /h/dk/r/ada10dlu/edan65/simpc/src/jastadd/NameAnalysis.jrag:153
   */
  ...
  /**
   * @aspect PrettyPrint
   * @declaredat /h/dk/r/ada10dlu/edan65/simpc/src/jastadd/PrettyPrint.jrag:216
   */
  ...
  /**
   * @aspect Visitor
   * @declaredat /h/dk/r/ada10dlu/edan65/simpc/src/jastadd/Visitor.jrag:60
   */
